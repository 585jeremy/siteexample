...
{slug:"social",short:"SOC",name:"Social Team",roleId:"1466548066604810426",eyebrow:"Community pulse",summary:"Post scheduling, public communication planning, and prepared engagement surfaces for future analytics.",preview:["Content calendar","Announcement sync","Prepared engagement watch"],ch:[["Post calendar","Scheduling, platform timing, and post planning."],["Campaign sync","Cross-team alignment for releases, events, and promotions."],["Announcement mirror","Public messaging coordination with Management and Content Creator."],["Community pulse","Prepared view for reaction, reach, and momentum signals."]],fn:[["Content calendar","Track upcoming posts, deadlines, and platform needs.","ready"],["Announcement sync","Coordinate outgoing communication across teams and channels.","ready"],["Prepared community pulse","Prepared dashboard for reaction and engagement patterns.","prepared"],["Prepared campaign analytics lane","Prepared summary board for future post and campaign metrics.","prepared"]],live:[["Scheduled post queue","Upcoming posts and release timing.","ready"],["Announcement lane","Active or pending public messaging items.","ready"],["Prepared engagement watch","Prepared future live reaction and momentum stream.","prepared"],["Community highlights","Wins, moments, and content opportunities worth amplifying.","ready"]]}
];
...
function gateStoragePayload(account){const applicationPermissions=account&&account.applicationPermissions&&typeof account.applicationPermissions==="object"?account.applicationPermissions:{};return {username:account.username||account.staffId||"",displayName:account.displayName||account.name||account.username||account.staffId||"Staff Access",clearance:account.clearance||"General Staff",issuedBy:account.issuedBy||"Management Team",portalAccess:account.portalAccess||"",applicationPermissions:{canReview:!!applicationPermissions.canReview,canManage:!!applicationPermissions.canManage}};}
...
function hasGateManagementAccess(){const account=state.gate.account; if(!account)return false; const portalAccess=accessTokens(account.portalAccess); const clearance=normalize(account.clearance); return portalAccess.includes("all")||portalAccess.includes("management")||clearance==="management"||clearance==="manager";}
